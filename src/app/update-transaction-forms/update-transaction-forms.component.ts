...
export class UpdateTransactionFormsComponent implements OnInit {
  ...
  checkStatus() {
    ...
    if (this.checkLoginStatus != 'true') {
      ...
      if (
        ...
        this.everything.orderCreatedBy === 'Sample Head1' ||
        this.everything.orderCreatedBy === 'Sample Head2' ||
      ...
      (localStorage.getItem('token') === 'Administrator' ||
        localStorage.getItem('token') === 'Sample Head1' ||
        localStorage.getItem('token') === 'Sample Head2' ||
  ...
  wovenCheck() {
    ...
    if (
      (this.newAccessToken === 'Administrator' ||
        this.newAccessToken === 'Sample Head1' ||
        this.newAccessToken === 'Sample Head2' ||
  ...
  tagCheck() {
    ...
    if (
      (this.newAccessToken === 'Administrator' ||
        this.newAccessToken === 'Sample Head1' ||this.newAccessToken === 'Sample Head2' ||
        this.newAccessToken === 'Customer Service Team') &&
      (this.everything.transactionStatus === 'Production' ||
        this.everything.transactionStatus === 'Quotation / Dispatch')
    ) {
  ...
  getSampleHeadEmail() {
    this.LoginService.checkAccessDetails('Sample Head1').subscribe((data) => {
      this.user = data;
